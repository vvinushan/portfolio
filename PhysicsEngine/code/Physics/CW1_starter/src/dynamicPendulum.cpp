...
DynamicPendulum::DynamicPendulum(b2World * world, sf::Vector2f position, sf::Vector2f size, sf::Vector2f anchor, float orientation, sf::Color colour)
{
	b2BodyDef l_bodyDef;
...
DynamicPendulum::DynamicPendulum(b2World * world, sf::Vector2f position, sf::Vector2f size, sf::Vector2f anchor, float orientation, sf::Texture * tex)
{
}

void DynamicPendulum::draw(sf::RenderTarget & target, sf::RenderStates states) const
{
	target.draw(m_rectangle);
}

void DynamicPendulum::update()
{
