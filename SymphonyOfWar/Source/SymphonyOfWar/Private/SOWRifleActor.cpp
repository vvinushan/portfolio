...
#include "SOWRifleActor.h"
#include <EnhancedInputComponent.h>
#include <EnhancedInputSubsystems.h>

// Sets default values
ASOWRifleActor::ASOWRifleActor()
{
	...
	//PlayerCharacter = Cast<ASOWPlayerCharacter>(GetWorld()->GetFirstPlayerController()->GetCharacter());
	...
	if (PlayerController != nullptr)
	{
		...
		EnhancedInputComponent->BindAction(AimAction, ETriggerEvent::Ongoing, this, &ASOWRifleActor::StartAimRifle);
		EnhancedInputComponent->BindAction(AimAction, ETriggerEvent::Completed, this, &ASOWRifleActor::StopAimRifle);
		EnhancedInputComponent->BindAction(FireAction, ETriggerEvent::Triggered, this, &ASOWRifleActor::FireRifle);
		EnhancedInputComponent->BindAction(ReloadAction, ETriggerEvent::Triggered, this, &ASOWRifleActor::ReloadRifle);
...
void ASOWRifleActor::BeginPlay()
{
	Super::BeginPlay();
	
	//FAttachmentTransformRules AttachmentRules(EAttachmentRule::SnapToTarget, true);
	////PlayerCharacter->AttachToComponent(PlayerCharacter->GetPlayerMesh(), AttachmentRules, "hand_r_weapon");
	//PlayerCharacter->AttachToComponent(PlayerCharacter->PlayerMesh, AttachmentRules, TEXT("hand_r_weapon"));
}

void ASOWRifleActor::SetupInputComponent()
{
	// Casts down pointer to current world player controller
...
void ASOWRifleActor::StartAimRifle()
{
}

void ASOWRifleActor::StopAimRifle()
{
}

void ASOWRifleActor::FireRifle()
{
...
void ASOWRifleActor::ReloadRifle()
{
}

// Called every frame
void ASOWRifleActor::Tick(float DeltaTime)
{
